                    ...
                    for(j=1;j<=num_file;j++){
                        ...
                        while(fscanf(datafile,"%s",data)!=EOF){
                            if(check){
                                ...
                                strcpy(current_grade,data);//get the grade of the student
                                break;
                            }
                            if(strcmp(data,id)==0){
                            ...
                            for(k=0;k<num_file;k++){
                                if(strcmp(course[k],current_course)==0){
                                    ...
                                    if(strcmp(year[k],current_year)<0){
                                        memset(year[k], 0, 20);
                                        memset(sem[k], 0, 20);
                                        strcpy(year[k],current_year);
                                        strcpy(sem[k],current_sem);
                                        memset(grade[k],0,20);
                                        strcpy(grade[k],current_grade);
                                    }
                        ...
                        if(check&&update){
                            ...
                            strcpy(course[index],current_course);
                            strcpy(year[index],current_year);
                            strcpy(sem[index],current_sem);
                            strcpy(grade[index],current_grade);
                            index++;
                        }
                        check=false;
                    }
